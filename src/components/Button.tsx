...
export type ButtonType = "blue" | "transparent" | "gray" | "arbitrary" | "close" | "linkLike"
...
export function Button(props: ButtonProps) {
  ...
  if (type === "arbitrary") {
    ...
    return (
      <button className="flex items-center justify-center p-1 rounded-full" style={colorSwitch(type)} onClick={action}>
...
function colorSwitch(type: ButtonType): CSSProperties {
  switch (type) {
    ...
    case "close":
      return { backgroundColor: "#E13838", border: "1px solid #F04141", color: "black" }
    default:
      return {};
  }
}
