...
export function Modal(props: ModalProps) {
  return (
    <>
      {props.isOpen &&
        <div className="fixed top-0 left-0 bottom-0 right-0 w-[100vw] h-[100vh] z-20">
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="min-w-[600px] min-h-[300px] p-8 bg-white rounded-lg">
              <div className="w-full flex justify-end"><Button type='close' onClick={props.handleClose} /></div>
